...
# Description
  The software emulates the components of a ship using Linux Network Namespaces. The core security software, which is the appliacation layer firewall, is then attached to the components' network. Using policy TOML file a user is able to define communication rules for the network
