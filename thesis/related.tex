...
In light of the maritime communication systems' current state, alternative solutions have been put forth. These proposals have identified the underlying issues as stemming from the utilization of outdated systems that employ data exchange methodologies devoid of any data analysis nor cyber/security considerations.
As illustrated in the article presented by the University of Posts and Telecommunications \cite{maritime_iot} and 
