...
Our implementation targets maritime OC systems whose internal communication is based on the NMEA-0183 and NMEA-2000 protocols, where information is sent via unencrypted UDP data frames containing ASCII payloads, with no restrictions on the flow direction of the communication.
...
\begin{tabularx}{\textwidth}{|>{\hsize=0.75\hsize}X|>{\hsize=1.25\hsize}X|}
  ...
  Attack & Methodology \\ \hline
    ...
    Spoofing &  Policies that determine a layer of encryption \\ \hline
    Packet Sniffing &    \\ \hline
    Replay/Man-in-the-Middle &  \\ \hline
\end{tabularx}
