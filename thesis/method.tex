...
\begin{tabularx}{\textwidth}{|>{\hsize=0.75\hsize}X|>{\hsize=1.25\hsize}X|}
  \hline
  \multicolumn{2}{|c|}{\textbf{NMEA protocols' vulnerabilities with L7 switch handled network}} \\ \hline
  Attack & Methodology \\ \hline
    ...
    Spoofing \& Packet Sniffing and Man In the Middle &  Policies can be configured to specify an encryption layer of the packet payload among components, thereby rendering spoofing techniques completely useless. In addition,  this kinds of attack require direct physical access to the cables connecting devices to the switch, an unlikely scenario \\ \hline
\end{tabularx}

% search for other security risks peculiar to maritime enviromente and write a little appendix on that before passing to the implementation
