...
Since the ultimate goal is to completely replace the hardware component, it is necessary to preserve basic routing for packets that are not bound to network policies. Thereby two main flows can be identified, basic and filtered.
