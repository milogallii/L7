...
\begin{figure}
	\centering\includegraphics[scale=0.23]{thesis/images/nmea2000_can.png}
	\caption{NMEA2000 Protocol with CAN Bus communication}\label{fig:nmea2000can}
\end{figure}
...
NMEA 2000 did not introduce any native security features pertaining to confidentiality, authentication, authorization, or non-repudiation and controls for potential attack vectors are left to be implemented by nodes in their own application-specific protocols operating on top of the marine network.

That said thes security of the protocol itself 
