...
The fourth iteration of the protocol resulting in a more advanced implementation that uses the CAN bus to facilitate communication. It supports higher data transfer rates and more complex data structures.
