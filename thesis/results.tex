...
\begin{tabularx}{\textwidth}{|>{\hsize=1\hsize}X|>{\hsize=1\hsize}X|>{\hsize=1\hsize}X|}
  ...
  \multicolumn{3}{|c|}{\textbf{Iperf tool results - Rust/AF\_XDP Multicast}} \\ \hline
    Role & Bitrate Mbit/s & Datagram size B\\ \hline
    SENDER_Girobussola & 1120 & 1460\\ \hline
    RECEIVER_ECDIS  & 1120 & 1460    \\ \hline
    RECEIVER_Radar & 1120 & 1460 \\ \hline
    SENDER_Girobussola & 4800 & 8972\\ \hline
    RECEIVER_ECDIS  & 4800  & 8972 \\ \hline
    RECEIVER_Radar & 4800 & 8972 \\ \hline
\end{tabularx}
