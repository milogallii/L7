...
\begin{figure}[H]
	\centering
    \includegraphics[scale=0.25]{images/architecture_overview.png}
...
decisions behind the project's structure and pondering the resulting performances (\autoref{ch:results}).
